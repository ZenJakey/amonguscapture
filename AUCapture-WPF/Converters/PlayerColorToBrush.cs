...
namespace AUCapture_WPF.Converters
{
    ...
    {
        public static readonly Dictionary<PlayerColor, Brush> BrushMapping = new() {
            ...
            { PlayerColor.Chocolate,  new SolidColorBrush(Color.FromRgb(73, 59, 54))},
            ...
            { PlayerColor.Azure,  new SolidColorBrush(Color.FromRgb(1, 166, 255))}
    ...
    public class PlayerColorToBrushShaded : IValueConverter
    {
        ...
        static PlayerColorToBrushShaded() {
            if (PlayerColorToBrush.BrushMapping[PlayerColor.Rainbow] is null) {
